...
var DISCORD_AUTH_URL = DISCORD_API_URL + '/oauth2/authorize';
var DISCORD_TOKEN_URL = DISCORD_API_URL + '/oauth2/token';
/**
...
function OAuth2Strategy(options, verify) {
  ...
  options = options || {};
  options.authorizationURL = options.authorizationURL || DISCORD_AUTH_URL;
  options.tokenURL = options.tokenURL || DISCORD_TOKEN_URL;
